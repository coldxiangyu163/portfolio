...
const COMMANDS = {
    help: () => [
        ...
        '  <span class="c-green">hire</span>       — 💼 雇佣我 / 咨询服务',
        '  <span class="c-green">sponsor</span>    — 💖 赞助支持',
    ...
    projects: () => [
        ...
        '  1000+ 精选 prompts，视觉化浏览，支持多工具（Midjourney/SD/DALL-E）',
        '  <span class="c-gray">Vanilla JS · PWA · GitHub Pages · 1091 prompts</span>',
        ...
        '',
        '<span class="c-white c-bold">AI Git Review</span>  <span class="c-gray">——</span> 免费 AI 代码审查 CLI',
        '  git commit 前自动审查，零成本（Gemini/DeepSeek），--fix 自动修复',
        '  <span class="c-gray">Node.js · LLM · Git Hooks · npm package</span>',
        ...
        '  分析网站在 ChatGPT/Perplexity/Gemini 中的可见性，蓝海市场',
        '  <span class="c-gray">Python · CLI · AI Search · PyPI package</span>',
        ...
        '',
        '<span class="c-white c-bold">git-who</span>  <span class="c-gray">——</span> AI 代码审查工具',
        '  git blame for AI — 逐行追踪 AI 生成代码，支持 Claude/Cursor/Copilot',
        '  <span class="c-gray">Node.js · git-notes · Code Review · npm package</span>',
        '  <span class="c-cyan">→ <a href="https://github.com/coldxiangyu163/git-who" target="_blank">github.com/coldxiangyu163/git-who</a></span>',
        '',
        '<span class="c-gray"># 48 小时开发 4 个项目，7100+ 行代码，110 个测试，全部 MIT 开源</span>',
        ''
    ],
    ...
    hire: () => [
        '',
        '<span class="c-yellow c-bold">💼 Hire Me / 咨询服务</span>',
        '',
        '<span class="c-white c-bold">我能帮你做什么：</span>',
        '',
        '  🚀 <span class="c-green">AI 应用快速原型</span>',
        '     从想法到 MVP，48 小时交付可用产品',
        '     擅长 CLI 工具、Agent 系统、LLM 集成',
        '',
        '  🔧 <span class="c-green">开源项目开发</span>',
        '     完整的项目生命周期：设计、开发、测试、文档、CI/CD',
        '     高质量代码，生产级标准',
        '',
        '  🎯 <span class="c-green">技术咨询</span>',
        '     AI 技术选型、架构设计、性能优化',
        '     MCP 生态、Multi-Agent 协作、RAG 系统',
        '',
        '  📚 <span class="c-green">代码审查 & 重构</span>',
        '     提升代码质量，优化架构，建立最佳实践',
        '',
        '<span class="c-white c-bold">定价：</span>',
        '',
        '  ⏱️  <span class="c-cyan">小时费率</span>     $80-150/小时',
        '  📦 <span class="c-cyan">项目报价</span>     $2000-10000（根据复杂度）',
        '  💬 <span class="c-cyan">技术咨询</span>     $100/小时',
        '  🎓 <span class="c-cyan">培训/指导</span>    $150/小时',
        '',
        '<span class="c-white c-bold">近期案例：</span>',
        '',
        '  • 48 小时开发 4 个开源项目（7100+ 行代码）',
        '  • AI Git Review - 免费 AI 代码审查工具',
        '  • GEO Analyzer - AI 搜索可见性分析（蓝海市场）',
        '  • PromptVault - 1000+ prompts 视觉图库',
        '',
        '<span class="c-white c-bold">联系方式：</span>',
        '',
        '  📧 Email: <a href="mailto:coldxiangyu@gmail.com">coldxiangyu@gmail.com</a>',
        '  💬 X/Twitter: <a href="https://x.com/coldxiangyu" target="_blank">@coldxiangyu</a>',
        '',
        '<span class="c-gray"># 首次咨询免费（30 分钟）</span>',
        ''
    ],

    sponsor: () => [
        '',
        '<span class="c-yellow c-bold">💖 Support My Open Source Work</span>',
        '',
        '<span class="c-white">我的所有项目都是 MIT 开源，免费使用。</span>',
        '<span class="c-white">如果你觉得有帮助，可以通过以下方式支持我：</span>',
        '',
        '<span class="c-white c-bold">GitHub Sponsors:</span>',
        '',
        '  ☕ <span class="c-cyan">$5/月</span>   Coffee Supporter',
        '     • README 署名',
        '     • Sponsor badge',
        '',
        '  🚀 <span class="c-cyan">$20/月</span>  Project Backer',
        '     • 优先 issue 响应（24h）',
        '     • 早期功能访问',
        '     • 路线图投票权',
        '',
        '  💎 <span class="c-cyan">$50/月</span>  Premium Sponsor',
        '     • 月度咨询 1 小时',
        '     • 定制功能请求',
        '     • 直接技术支持',
        '',
        '  🏢 <span class="c-cyan">$200/月</span> Business Sponsor',
        '     • 优先功能开发',
        '     • 项目主页 Logo',
        '     • 专属支持渠道',
        '',
        '<span class="c-white c-bold">赞助链接：</span>',
        '',
        '  🌐 GitHub Sponsors: <a href="https://github.com/sponsors/coldxiangyu163" target="_blank">github.com/sponsors/coldxiangyu163</a>',
        '  🇨🇳 爱发电（中文）: <a href="https://afdian.net/@coldxiangyu" target="_blank">afdian.net/@coldxiangyu</a>',
        '',
        '<span class="c-white c-bold">你的支持帮助我：</span>',
        '',
        '  ✅ 维护和改进现有项目',
        '  ✅ 开发新的开源工具',
        '  ✅ 编写教程和文档',
        ...
        '  ✅ 投入更多时间到开源',
        '',
        '<span class="c-gray"># 每一份支持都很重要，感谢你相信开源！🙏</span>',
        ''
    ],
